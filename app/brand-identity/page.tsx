...
export async function generateMetadata(): Promise<Metadata> {
  return getPageMetadata({
    ...
    defaults: {
      ...
      description:
        "Brand identity design for SMEs: the mark, the system and the rules that keep it consistent once your whole team is using it. Strategy first, then the design that executes it.",
    },
  });
}
      ...
      <section className="bg-dawn pt-[160px] md:pt-[200px] pb-[80px]">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <p className="mt-8 max-w-2xl text-[1.125rem] leading-[1.7] text-white/65">
            We design brand identities for businesses that have outgrown the one
            they have. The logo is the part everyone talks about and the
            smallest part of the job. What decides whether an identity survives
            is the system underneath it: the type, the colour, the rules, and
            whether a new starter can pick it up and get it right without
            asking. We settle the positioning first, then design against it.
          </p>
