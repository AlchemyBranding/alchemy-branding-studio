 ...
 *  - Posts identified as high-traffic via GSC will be removed from this
 *    list as they're chosen for re-creation.
 *
 * Currently preserved (not in this list — recreate in Sanity):
 ...
 *
 * To preserve a post, remove its slug from this array AND create the
 * matching blogPost document in Sanity Studio with the exact same slug.
 */
export const legacyBlogSlugs: readonly string[] = [
  ...
  "the-importance-of-sme-brand-strategy-for-growth-and-loyalty",
  ...
  "a-complete-guide-to-designing-an-effective-brand-identity-to-help-companies-stand-out-drive-loyalty-and-shape-market-perception",
  ...
  "discover-the-key-differences-between-brand-identity-strategy-and-marketing-strategy-for-long-term-success-and-immediate-impact",
  "six-new-businesses-with-brands-that-bang-2",
  "what-is-branding-why-even-a-one-man-band-cant-afford-to-skip-it",
  "your-logo-cheat-sheet-how-to-use-logo-file-formats",
  ...
  "our-work-for-the-tom-channon-safety-campaign-safety-advice-after-teens-death",
  ...
  "how-style-frames-can-help-you-meet-your-video-deadline",
