...
try{if(navigator.globalPrivacyControl!==true && window.localStorage.getItem('${STORAGE_KEY}')==='accepted'){gtag('consent','update',{'ad_storage':'granted','analytics_storage':'granted','ad_user_data':'granted','ad_personalization':'granted'});}}catch(e){}
